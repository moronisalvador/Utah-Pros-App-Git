...
export default function CreatePicker({ selectedDay, onClose }) {
  ...
  const dateLabel = new Date(selectedDay + 'T00:00:00').toLocaleDateString(currentLocaleTag(), {
    ...
    <div className="tv2-sheet-backdrop" onClick={onClose}>
      <div className="tv2-sheet" onClick={(e) => e.stopPropagation()}>
        <div className="tv2-sheet__head">
          <div className="tv2-sheet__title">{t('createNew')}</div>
        ...
        >
          ...
          <span className="tv2-sheet__text">
            <span className="tv2-sheet__label">{t('jobAppt')}</span>
            <span className="tv2-sheet__desc">{t('jobApptSub')}</span>
          </span>
        ...
        >
          ...
          <span className="tv2-sheet__text">
            <span className="tv2-sheet__label">{t('event')}</span>
            <span className="tv2-sheet__desc">{t('eventSub')}</span>
          </span>
          <span className="tv2-sheet__chev">›</span>
        </button>
      </div>
