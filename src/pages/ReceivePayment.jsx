...
export default function ReceivePayment() {
  ...
  return <div className="coll-page" style={{ overflowX: 'clip' }}><header className="coll-header"><div><h1 className="coll-title">Receive payment</h1><div className="coll-subtitle">Create one QuickBooks payment and allocate it across open invoices.</div></div><div className="coll-actions"><GhostButton onClick={() => navigate(BACK_TARGET)}>{IS_NATIVE_BUILD ? '← Back' : '← Payments'}</GhostButton></div></header><ReceivePaymentForm
    contacts={contacts || []}
    data={contactData}
