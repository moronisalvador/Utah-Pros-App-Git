    ...
    <Screen>
      <Card>
        ...
        <p style={styles.sub}>
          ...
          {data?.signed_at
            ? new Date(data.signed_at).toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })
            : 'a previous date'}.
        </p>
        ...
        <div style={styles.content}>
          ...
          <div style={styles.fieldGroup}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
              ...
              {hasSig && (
                <button style={styles.clearBtn} onClick={clearSig} disabled={status === 'submitting'}>
                  Clear
                </button>
              )}
            </div>
            <div style={styles.canvasWrap}>
              ...
              />
              {!hasSig && (
                <p style={styles.canvasHint}>Sign here with your finger or mouse</p>
              )}
            </div>
          </div>
