 ...
 *   job creator), a Customer, or an Invoice. It doesn't do the work itself; it
 *   just tells the app shell which "create" pop-up to open.
 *
 * WHERE IT LIVES:
 ...
 * DEPENDS ON:
 *   Packages:  react
 *   Internal:  @/lib/navItems (IconPlus)
 *   Data:      reads → none · writes → none (delegates via onAction)
 *
 * NOTES / GOTCHAS:
