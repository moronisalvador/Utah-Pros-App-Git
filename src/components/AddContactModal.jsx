...
export function LookupSelect({label,value,onChange,items,placeholder='Search...',nameKey='name',required=false}){
  ...
  return(<div className="form-group" style={{flex:1,marginBottom:0}} ref={wr}><label className="label">{label}{required&&<span style={{color:'#ef4444',marginLeft:2}}>*</span>}</label><div className="carrier-select-wrap">
