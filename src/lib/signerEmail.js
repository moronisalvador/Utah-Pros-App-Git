 ...
 *   - DUPLICATED DELIBERATELY in functions/api/resend-esign.js. `functions/` is a
 *     separate Cloudflare bundle and cannot import from `src/`, so the rule genuinely
 *     exists twice; tests/qa/unit/esign-resend-truthfulness.test.js pins the pair.
