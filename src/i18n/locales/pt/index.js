/**
 * ════════════════════════════════════════════════
 * FILE: index.js (Portuguese locale bundle)
 * ════════════════════════════════════════════════
 *
 * WHAT THIS DOES (plain language):
 *   Gathers every Portuguese word list into one object the translation engine
 *   can load in a single step.
 *
 *   This file exists so Portuguese can be fetched ONLY when somebody actually
