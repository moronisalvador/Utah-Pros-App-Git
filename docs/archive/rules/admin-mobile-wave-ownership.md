...
> **ARCHIVED 2026-07-13** (moved from `.claude/rules/` per CLAUDE.md's manifest-archival rule):
> the initiative is complete — all 7 phases (F, P1, P2, P3, P4a, P4b, P5) merged to `dev`
