...
- [x] Phase F1 — dispatched 2026-07-17, PR #451 (owner to merge + Xcode-verify)
- [x] Phase A — dispatched 2026-07-17, PR #452 (migration applied live)
- [x] Phase B — dispatched 2026-07-17, PR #454 (migration applied live)
- [x] Phase D — dispatched 2026-07-17, PR #453
- [x] Phase F2 (non-Xcode slice) — icon/splash + `/support` page + ASC metadata packet, 2026-07-17
