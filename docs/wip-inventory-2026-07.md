...
|---|---|---|---|---|
| 1 | ~~**Mobile readiness — current-origin reconciliation**~~ | **CLOSED 2026-07-29** — owner accepted the handback; lease released. Work landed via PR #525 (merged 2026-07-27); holder branch had 0 commits not in `dev` at acceptance | Nothing — the repo's widest sole-writer lease is gone | **ACCEPTED.** Row retained for one revision as history; delete on the next inventory rewrite. |
