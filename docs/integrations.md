...
API token is attached. UPR never presents the API credential to the browser-session app host or
relies on a numeric-account redirect. Redirects are handled manually. UPR follows
