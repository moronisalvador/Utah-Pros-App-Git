...
On 2026-07-31 the hosted lane reported 163 / 375 assertions passed, 0 failed, and 212 skipped at
commit `19b3e64a`; zero failed assertions is now the hard gate, while the skips and six local-only
SQL/pgTAP proofs remain explicit coverage debt.
