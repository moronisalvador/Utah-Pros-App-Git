...
| MOB-SEC-014 | Mobile trusted authorization boundary | PARTIAL | r0_s1a_local_verified | P0 | `mobile-readiness-r0-recapture-2026-07-25.md`; four QBO Workers gated/tested locally; 68 mobile RPCs and current residual Workers recaptured | S1b remaining QBO; CallRail/notify; route-family RPC/direct-policy containment; external identities/deploy verification | Mobile security owner |
