...
**Draft refreshed:** 2026-07-23 on `dev`; P1 isolated-QA/Figma internal close-out
...
| GOV-001 | Canonical skills/agents source and adapters | PARTIAL pilot implemented | verification_tail | P1 | `tooling/capabilities.json`; generated four-dispatcher Claude/Codex adapters; renderer/drift/routing tests; reviewer parity for pattern/Worker/DB Foundation | Runtime smoke in fresh Claude/Codex sessions; inventory and migrate remaining UPR-authored entrypoints deliberately; leave unrelated candidate ports non-authoritative | Governance owner |
