...
| UPRF-DOC-001 | canonical documentation reconciliation | HAVE | verified | none | archived for 2026-07-23 close | Medium / completed P1 | DOC-001, `engineering-foundation-documentation-closure-2026-07-23.md`, `git-ledger-2026-07-23.md` | none | canonical docs, UPR context, generated catalog, Git/live ledger | July 23 closure complete; reopen on the next mutation or status change |
...
| BRANCH-001 | Unreconciled worktrees/branches | PARTIAL | owner_gate | P1 | `git-ledger-2026-07-23.md`; messaging branches reconciled into `dev`; `3841056` superseded by isolated-QA addendum; unreferenced `d3fd17a` is the deleted temporary recovery implementation and is superseded by completed live recovery/cleanup | Never merge `3841056` or `d3fd17a`; owner may archive reconciled/superseded branches and retire worktrees after confirming no user-owned changes; no blind delete | Owner/release |
