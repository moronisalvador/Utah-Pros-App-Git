...
| DES-002 | Figma operating model | PARTIAL checkpoint | owner_blocked | P1 | `figma-readiness-checkpoint-2026-07-23.md` | clear the dirty shared-UI worktree; CAP-SEC/GOV owner actions; approve permission mode/authority; provide dedicated authenticated read-only staging session; then exact first sprint | Design owner |
