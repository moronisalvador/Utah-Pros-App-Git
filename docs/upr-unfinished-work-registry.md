...
| MOB-SEC-014 | Mobile trusted authorization boundary | PARTIAL | r0_s1a_local_verified | P0 | `mobile-readiness-r0-recapture-2026-07-25.md`; four QBO Workers gated/tested locally; 82 transitive mobile RPCs (including two anon/PUBLIC) and current residual Workers recaptured | S1b remaining QBO; CallRail/notify; shared identity/device/bell/merge plus route-family RPC/direct-policy containment; external identities/deploy verification | Mobile security owner |
