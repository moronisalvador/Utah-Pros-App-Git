...
| UPRF-MOB-001 | Mobile PWA/Capacitor production readiness | PARTIAL | foundation_ready | internal + owner + external | active | Critical / P0 | 2026-07 mobile audit: 2 P0, 21 P1, 14 P2; `mobile-production-readiness-roadmap.md` | owner + mobile wave owner | PWA, tech/admin mobile, durable device state, workers/RPC/RLS/Storage, Capacitor/iOS, release/device proof | Run R0 from current `origin/dev`; contain `MOB-SEC-014/015`; then ordered data/compliance/release/PWA/native/quality waves; no live apply/deploy/signing by implication; retire after fresh qualification audit |
