...
**Draft refreshed:** 2026-07-26; mobile S1f bell-emission migration locally verified, not applied
...
| UPRF-MOB-001 | Mobile PWA/Capacitor production readiness | PARTIAL | s1f_bell_rpc_ready_for_apply | internal + owner + external | active | Critical / P0 | 2026-07 mobile audit: 2 P0, 21 P1, 14 P2; `mobile-production-readiness-roadmap.md`; R0→S1f dated evidence; separate S1d/S1e/S1f unapplied migrations | owner + mobile wave owner | PWA, tech/admin mobile, durable device state, workers/RPC/RLS/Storage, Capacitor/iOS, release/device proof | Keep S1d/S1e/S1f applies separate; next source slice is notification read/mark recipient binding, followed by shared identity/device/preferences, merge, public signing, and route-family RPC/RLS; QBO residuals and private media remain separately owned; no live apply/deploy/signing by implication; retire after fresh qualification audit |
