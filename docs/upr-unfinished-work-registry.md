...
| UPRF-NIOS-001 | parallel native Swift iOS client | HAVE plan | plan_ready_implementation_not_started | owner review + Mac/Xcode + QA | active | High / P1 | `docs/native-ios/README.md`, ADRs 0001/0002, owner decisions 2026-07-25/26 | owner + native orchestrator | planning docs now; future Swift project paths only after architecture/ownership checkpoint | Apple Field Pro evolution approved; on Mac close remaining device/field/native-translation/architecture/first-slice and isolated-QA gates before code; preserve PWA/Capacitor; retire only after controlled native cutover and sustained operations |
...
| NIOS-001 | Parallel native Swift iOS application | HAVE plan | owner_review | P1 | `docs/native-ios/`; accepted ADRs 0001/0002; Apple Field Pro evolution approved; base `90b265e` | Complete remaining field/device/native-translation workshop on Mac; approve architecture/first vertical slice; open governed QA; do not modify or retire Capacitor during planning | Owner + native orchestrator |
