...
**Draft refreshed:** 2026-07-26; mobile S1c CallRail/notify HTTP slice locally verified
...
| UPRF-MOB-001 | Mobile PWA/Capacitor production readiness | PARTIAL | s1c_callrail_notify_local_verified | internal + owner + external | active | Critical / P0 | 2026-07 mobile audit: 2 P0, 21 P1, 14 P2; `mobile-production-readiness-roadmap.md`; R0 plus S1b/S1c dated evidence; S1a commits `66182f3..e42edb5`; S1b source/test commits `e124ded`, `a1255e2`, `49c2cf8`, `fb7af3f` | owner + mobile wave owner | PWA, tech/admin mobile, durable device state, workers/RPC/RLS/Storage, Capacitor/iOS, release/device proof | Next S1d contains the authenticated-executable `notify_emit` definer capability in a separate reviewed migration; then recording-source RLS, shared identity/device/bell/merge/public-signing and route-family RPC/RLS slices; QBO residuals are separately owned below; private media remains a separate compatibility/apply wave; no live apply/deploy/signing by implication; retire after fresh qualification audit |
...
| MOB-SEC-014 | Mobile trusted authorization boundary | PARTIAL | s1c_callrail_notify_local_verified | P0 | R0, S1b and `mobile-readiness-s1c-callrail-notify-2026-07-26.md`; nine QBO Worker routes plus CallRail recording/notify HTTP locally contained; `notify_emit`, recording-source reads, 84 client-reachable mobile RPCs (82 authenticated-tech + two public-signing; four anon/three PUBLIC) and broad direct policies remain | S1d `notify_emit` ACL/body containment; then recording-source RLS and shared identity/device/bell/merge/public-signing plus route-family RPC/direct-policy slices; deploy/representative-identity verification; QBO telemetry/RLS tracked separately as UPRF-MOB-QBO-AUD-001/UPRF-MOB-QBO-RLS-001 | Mobile security owner |
