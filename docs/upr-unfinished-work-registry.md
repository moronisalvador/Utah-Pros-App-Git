...
| GOV-001 | Canonical skills/agents source and adapters | PARTIAL | mobile_pilot_verified | P1 | `tooling-capability-review.md:152-202`; `.claude/mobile-readiness-codex-adapters.json`; adapter tests | Preserve `.claude` authority and generated mobile adapters; prove broader neutral package and cross-runtime safety fixtures before another domain | Governance owner |
