...
**Draft refreshed:** 2026-07-25; mobile PWA/Capacitor audit and readiness foundation added
...
| UPRF-MOB-001 | Mobile PWA/Capacitor production readiness | PARTIAL | r0_recaptured_s1a_local_verified | internal + owner + external | active | Critical / P0 | 2026-07 mobile audit: 2 P0, 21 P1, 14 P2; `mobile-production-readiness-roadmap.md`; `mobile-readiness-r0-recapture-2026-07-25.md`; local QBO source/test commits `66182f3..e42edb5` | owner + mobile wave owner | PWA, tech/admin mobile, durable device state, workers/RPC/RLS/Storage, Capacitor/iOS, release/device proof | Next S1b contains remaining QBO identities; then CallRail/notify and route-family RPC/RLS slices; private media remains a separate compatibility/apply wave; resolve product/pilot decisions; no live apply/deploy/signing by implication; retire after fresh qualification audit |
...
| MOB-SEC-014 | Mobile trusted authorization boundary | PARTIAL | r0_s1a_local_verified | P0 | `mobile-readiness-r0-recapture-2026-07-25.md`; four QBO Workers gated/tested locally; 84 client-reachable mobile RPCs (82 authenticated-tech + two public-signing; four anon/three PUBLIC) and current residual Workers recaptured | S1b remaining QBO; CallRail/notify; shared identity/device/bell/merge/public-signing plus route-family RPC/direct-policy containment; external identities/deploy verification | Mobile security owner |
