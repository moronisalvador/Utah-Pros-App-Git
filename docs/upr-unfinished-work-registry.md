...
**Draft refreshed:** 2026-07-26; mobile S1b QBO identity slice locally verified
...
| UPRF-MOB-001 | Mobile PWA/Capacitor production readiness | PARTIAL | s1b_qbo_local_verified | internal + owner + external | active | Critical / P0 | 2026-07 mobile audit: 2 P0, 21 P1, 14 P2; `mobile-production-readiness-roadmap.md`; R0 and `mobile-readiness-s1b-qbo-identity-2026-07-26.md`; S1a commits `66182f3..e42edb5`; S1b source/test commits `e124ded`, `a1255e2`, `49c2cf8`, `fb7af3f` | owner + mobile wave owner | PWA, tech/admin mobile, durable device state, workers/RPC/RLS/Storage, Capacitor/iOS, release/device proof | Next S1c contains CallRail recording/notification identities; then shared identity/device/bell/merge/public-signing and route-family RPC/RLS slices; separately gate external-admin `qbo_attachments` metadata policy and decide durable QBO human-actor telemetry; private media remains a separate compatibility/apply wave; no live apply/deploy/signing by implication; retire after fresh qualification audit |
...
| MOB-SEC-014 | Mobile trusted authorization boundary | PARTIAL | s1b_qbo_local_verified | P0 | R0 and `mobile-readiness-s1b-qbo-identity-2026-07-26.md`; nine QBO Worker routes gated/tested locally across S1a/S1b; human actor not persisted by customer/manual-payment sync; 84 client-reachable mobile RPCs (82 authenticated-tech + two public-signing; four anon/three PUBLIC) and current residual Workers recaptured | S1c CallRail/notify; shared identity/device/bell/merge/public-signing plus route-family RPC/direct-policy containment; separately migrate external-admin attachment-metadata SELECT and design QBO actor telemetry; deploy/representative-identity verification | Mobile security owner |
