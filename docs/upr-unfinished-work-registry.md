...
planning row added 2026-07-25; other rows were not broadly re-audited by that planning update.
...
| UPRF-NIOS-001 | parallel native Swift iOS client | HAVE plan | plan_ready_implementation_not_started | owner review + Mac/Xcode + QA | active | High / P1 | `docs/native-ios/README.md`, ADR 0001, owner decision 2026-07-25 | owner + native orchestrator | planning docs now; future Swift project paths only after architecture/ownership checkpoint | Review owner decisions on Mac; approve architecture/design/first slice and isolated QA before code; preserve PWA/Capacitor; retire only after controlled native cutover and sustained operations |
...
| NIOS-001 | Parallel native Swift iOS application | HAVE plan | owner_review | P1 | `docs/native-ios/`; accepted ADR 0001; base `90b265e` | Complete owner workshop on Mac; approve design/architecture/first vertical slice; open governed QA; do not modify or retire Capacitor during planning | Owner + native orchestrator |
