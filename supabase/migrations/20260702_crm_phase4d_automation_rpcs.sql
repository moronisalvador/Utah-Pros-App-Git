-- ═══════════════════════════════════════════════════════════════════════════
-- CRM Phase 4d — fill the two frozen automation-settings RPC stubs.
--
-- FUNCTION-BODY-ONLY CREATE OR REPLACE (roadmap v3 wave rule): signatures are
-- IDENTICAL to Phase F's stubs in 20260702_crm_phaseF_rpc_stubs.sql —
...
-- authenticated. Org resolution mirrors the existing CRM RPCs
-- (crm_manual_lead.sql etc.): COALESCE(p_org_id, first non-test org).
-- ═══════════════════════════════════════════════════════════════════════════
