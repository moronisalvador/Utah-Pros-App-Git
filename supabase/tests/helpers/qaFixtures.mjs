 ...
 *
 * NOTES / GOTCHAS:
 *   - Test-only credentials for an isolated branch database, deliberately
 *     committed. If these accounts exist in production, that is an incident.
...
export const QA_FIXTURE_PASSWORD = 'UprQaFixture!2026';
