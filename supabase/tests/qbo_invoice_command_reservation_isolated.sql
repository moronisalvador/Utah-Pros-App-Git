...
-- A PostgreSQL service role alone is not a trusted request context. With no
-- role claim, every service-only definer guard must deny before validation or
-- any reservation write.
...
BEGIN
  BEGIN
    PERFORM public.reserve_qbo_invoice_command(
      'c4000000-0000-4000-8000-0000000000a3',
      'c3000000-0000-4000-8000-000000000001',
      'save', 'c9000000-0000-4000-8000-000000000001', NULL, 'browser', 'realm-a'
    );
    RAISE EXCEPTION 'claimless service role executed reservation RPC';
  EXCEPTION WHEN insufficient_privilege THEN
    IF SQLERRM NOT LIKE '%not_authorized: service role required%' THEN RAISE; END IF;
  END;
END;
