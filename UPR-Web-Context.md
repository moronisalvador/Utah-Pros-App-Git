...
src/
  ...
  pages/
    ...
    Schedule.jsx                  — Calendar dispatch board (Day/3Day/Week/Month) — UPR design system shell + Week Calendar (Jun 2026); Jobs/Crew/Month views pending reskin
