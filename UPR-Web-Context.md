...
functions/
  ...
  lib/
    ...
    messaging-transport.js       — Provider-neutral seam used only by staff `/api/send-message`; Phase 1 registers Twilio only and fails closed for unsupported providers. Scheduled/automated/campaign senders remain explicitly Twilio-only.
